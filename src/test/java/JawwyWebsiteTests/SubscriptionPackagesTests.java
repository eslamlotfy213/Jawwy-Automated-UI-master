...
public class SubscriptionPackagesTests extends WebTestBase {
    ...
    public void validateSubscriptionPackagesForEgypt(){
        ...
        NotepadWriter.printTestValuesToNotepad("src/main/java/OutputFiles/TestsOutputValues.txt",homePageObj.verifyLitePackage_PriceUnit());
        NotepadWriter.printTestValuesToNotepad("src/main/java/OutputFiles/TestsOutputValues.txt",homePageObj.verifyClassicPackage_PriceUnit());
        NotepadWriter.printTestValuesToNotepad("src/main/java/OutputFiles/TestsOutputValues.txt",homePageObj.verifyPremiumPackage_PriceUnit());
